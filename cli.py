...
def main():
    ...
    localIP = '127.0.0.1'
    serverPort = 8080
    clientSocket = socket.socket(family=socket.AF_INET, type=socket.SOCK_STREAM)      #Creates a TCP connection to redirects
    ...
    clientSocket.sendto(byteData,(localIP,int(serverPort)))
